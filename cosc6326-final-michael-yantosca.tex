...
\section{Analysis}{
  \subsection{\texttt{ghs-coco}}{
    ...
    \paragraph{}{
      \begin{algorithm}
        \footnotesize
        \caption{\textsc{GHS-Connected-Components-Find-MWOE-Receive}, Send Phase of Algorithm~\ref{alg:ghs-coco-find-mwoe} }
...
\section{Results}{
  ...
  \subsection{Component Statistics}{
    ...
    \paragraph{}{
      ...
      There is not much more to say beyond what was covered in the previous report except that this provides some
